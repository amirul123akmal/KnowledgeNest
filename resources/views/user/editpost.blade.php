...
@section('content')
    ...
    <main class="min-h-screen sm:px-6 lg:px-8 bg-linear-to-b from-indigo-50/50 to-white pt-16 pb-20">
        <div class="max-w-6xl mx-auto pt-10">
            ...
            <div class="mb-8 md:flex md:items-center md:justify-between">
                <div class="min-w-0 flex-1">
                    ...
                    <p class="text-slate-500">
                        Update your knowledge or service details.
                    </p>
                </div>
                <div class="mt-4 flex md:ml-4 md:mt-0">
                    <a href="{{ route('posts.show', $post->id) }}" class="text-sm font-medium text-slate-600 hover:text-slate-900">Back</a>
                </div>
            </div>
            @if ($errors->any())
            ...
            <form id="postForm" class="space-y-8" method="POST" action="{{ route('posts.update', $post) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="glass-panel shadow-lg shadow-slate-200/50 rounded-2xl border border-white p-6">
                            ...
                            <div class="mt-8 pt-6 border-t border-slate-100 flex flex-col gap-3">
                                ...
                                <a href="{{ route('posts.index') }}" class="w-full text-center rounded-xl bg-white px-3.5 py-2.5 text-sm font-semibold text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 hover:bg-slate-50">
                                    Cancel
                                </a>
                            </div>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-blue-700">
                                        <p>Keeping content updated helps more people!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        // Initialize label based on current value
